Desafio feito para:
- treino de testes de software, utilizando o framework JUnit 5 e mockito.
- treino de desenvolvimento de software, utilizando o framework Spring Boot, com camada de service.
- Aprendizado de Fila de mensagens com RabbitMQ.

## Como rodar:
Vá a pasta /local e digite:
```
  docker-compose up
```
